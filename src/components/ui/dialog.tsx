...
>(({ className, children, ...props }, ref) => {
  ...
  const fallbackDescId = `dialog-desc-${uid}`;
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      {...props}
        aria-describedby={ariaDescribedBy ?? fallbackDescId}
      >
      {children}
      {/* Render a visually-hidden description element when none provided to satisfy accessibility checks */}
      {!ariaDescribedBy && (
