...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
          ...
          <div className="premium-card p-6">
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold leading-tight">Jessica L.</p>
                  <p className="text-xs text-muted-foreground">Paid Surveys · Florida</p>
                </div>
              </div>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex items-center justify-between rounded-xl border border-border/60 bg-background/40 p-3">
                  <div className="flex items-center gap-3">
                    <div className="h-9 w-9 rounded-lg bg-primary/10 flex items-center justify-center text-primary">
                      <item.icon className="h-4 w-4" />
                    </div>
                    <div>
                      <p className="text-sm font-medium leading-tight">{item.t}</p>
      ...
      {/* How It Works */}
      <section id="how" className="py-20 bg-accent/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <p className="text-sm font-semibold tracking-widest text-primary uppercase mb-3">Simple Process</p>
            <h2 className="text-3xl sm:text-4xl font-bold">Three steps to your first payout</h2>
            <p className="mt-4 text-muted-foreground">No resumes, no interviews — just share your opinion and get rewarded.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {steps.map((step) => (
              <div key={step.no} className="premium-card p-8 text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-6 items-end mb-12">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold">Paid surveys, app tests, rewards & more.</h2>
            </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map((f) => (
              <div key={f.title} className="premium-card-small p-5 flex items-center gap-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-6 items-end mb-12">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold">Real people earning with their opinion</h2>
            </div>
            <p className="text-muted-foreground lg:text-right">15,000+ members are already earning with SurveyForever.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
              <div
              ...
              >
                ...
                <p className={`text-sm leading-relaxed ${t.featured ? "" : "text-muted-foreground"}`}>"{t.quote}"</p>
                <div className="flex items-center gap-3 mt-6">
                  ...
                  <div>
                    ...
                    <p className={`text-xs ${t.featured ? "text-primary-foreground/80" : "text-muted-foreground"}`}>{t.loc}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section id="faq" className="py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <Accordion type="single" collapsible className="space-y-3">
            {faqs.map((faq, i) => (
              <AccordionItem key={i} value={`item-${i}`} className="premium-card-small px-5 border-0">
      ...
      <section className="pb-20 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto rounded-3xl bg-gradient-primary p-10 sm:p-14 grid lg:grid-cols-2 gap-8 items-center">
          <div>
      ...
      <footer className="border-t border-border/50 py-12">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-8 pt-6 border-t border-border/30">
